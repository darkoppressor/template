...
LOCAL_EXPORT_C_INCLUDES := $(LOCAL_PATH)/../include/SDL2_image/external/libpng-1.6.32
include $(PREBUILT_STATIC_LIBRARY)
...
LOCAL_STATIC_LIBRARIES := png_static ogg_static vorbisidec_static SDL2_main SDL2_static SDL2_image_static SDL2_mixer_static RakNet_static
include $(PREBUILT_STATIC_LIBRARY)
